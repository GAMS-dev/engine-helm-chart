...
| broker.service.version2.affinity | object | `{}` | Affinity settings for V2 pod assignment. |
| broker.service.version2.enabled | bool | `false` | Enable the V2 version of the Broker API. |
| broker.service.version2.maxReplicas | int | `3` | Max replicas for Broker V2 HPA. |
| broker.service.version2.monitoring.metricsEnabled | bool | `false` | Expose V2 metrics at /api/metrics. |
| broker.service.version2.monitoring.podMonitorEnabled | bool | `false` | Create a Prometheus Operator PodMonitor for V2. |
